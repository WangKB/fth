...
import com.puyuntech.flowerToHome.DateEditor;
import com.puyuntech.flowerToHome.Setting;
import com.puyuntech.flowerToHome.StringEditor;
import com.puyuntech.flowerToHome.enmu.Message;
import com.puyuntech.flowerToHome.exception.IllegalLicenseException;
import com.puyuntech.flowerToHome.exception.ResourceNotFoundException;
import com.puyuntech.flowerToHome.template.directive.FlashMessageDirective;
 ...
 * 
 * Controller - 基类 . 
 * Created on 2015-8-25 下午4:53:27 
 * @author 王凯斌
 * 
 * 提供常量 
 * 	错误试图位置
...
public class BaseController {
	...
	/**
	 * @InitBinder spring mvc对表单数据进行绑定
	 * 
	 * @param binder
	 *            WebDataBinder
	 */
