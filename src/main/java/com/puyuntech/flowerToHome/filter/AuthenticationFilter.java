...
import com.puyuntech.flowerToHome.AuthenticationToken;
 ...
 * 
 * Filter - 权限认证 . 
 * Created on 2015-8-14 下午4:45:17 
 * @author 王凯斌
 * 
...
public class AuthenticationFilter extends FormAuthenticationFilter {
	...
	protected boolean onAccessDenied(ServletRequest servletRequest, ServletResponse servletResponse) throws Exception {
		...
		String loginToken = com.puyuntech.flowerToHome.util.WebUtils.getCookie(request, Admin.LOGIN_TOKEN_COOKIE_NAME);
