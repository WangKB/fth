package com.puyuntech.flowerToHome.plugin;
...
/**
 * 
 * Plugin - 存储. Created on 2015-10-14 下午1:39:20
 * 
 * @author 王凯斌
 */
public abstract class StoragePlugin implements Comparable<StoragePlugin> {
	...
	public PluginConfig getPluginConfig() {
		PluginConfig config = pluginConfigService.findByPluginId(getId());
		return config;
	}
...
//		TODO 无法正常返回true，暂时直接返回真值
//		PluginConfig pluginConfig = getPluginConfig();
//		return pluginConfig != null ? pluginConfig.getIsEnabled() ==1: false;
		return true;
	}
