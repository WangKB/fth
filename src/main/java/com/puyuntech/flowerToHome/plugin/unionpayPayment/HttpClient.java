...
import com.puyuntech.flowerToHome.plugin.unionpayPayment.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;
...
public class HttpClient {
	 ...
	 * @return
	 */
	private String getRequestParamString(Map<String, Object> requestParam, String coder) {
		...
		if (null != requestParam && 0 != requestParam.size()) {
			for (Entry<String, Object> en : requestParam.entrySet()) {
				try {
					sf.append(en.getKey()
							+ "="
							+ (null == en.getValue() || "".equals(en.getValue()) ? "" : URLEncoder
									.encode(String.valueOf(en.getValue() ), coder)) + "&");
