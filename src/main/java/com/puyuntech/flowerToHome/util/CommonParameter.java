...
public class CommonParameter {
     ...
     * 微信支付Id
     */
    public static String WEIXIN_PAYMENT = "weixinPaymentPlugin";

    /**
     * 现金支付Id
     */
    public static String CASH_PAYMENT = "cashPaymentPlugin";

    /**
     * 银联支付 Id
     */
    public static String UNION_PAYMENT = "unionPaymentPlugin";
