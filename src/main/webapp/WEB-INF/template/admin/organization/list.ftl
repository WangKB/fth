	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="address">门店名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="address">门店地址</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="tel">联系电话</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="level">门店等级</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="intro">门店介绍</a>
				</th>
				<th>
			...
			[#list page.content as organization]
				<tr>
					...
					<td>
						${message("Organization.level."+organization.level)}
					</td>
					<td>
						${organization.intro}
					</td>
					<td>
						<a href="edit.jhtml?id=${organization.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
