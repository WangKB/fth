...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; 添加帮助中心内容
	</div>
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<select name="problemClassificationId">
			...
			<tr>
				...
				<td>
					<textarea id="desc" name="desc" class="editor"></textarea>
				</td>
			</tr>
