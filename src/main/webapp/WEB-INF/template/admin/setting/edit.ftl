...
$().ready(function() {
    ...
    /* 对Input生成富文本编辑器 */
    $("#footerLawInfo").editor();
    $("#footerAbout").editor();
    $("#footerContact").editor();
    $("#lineExperience").editor();
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		<ul id="tab" class="tab">
			...
			<li>
				<input type="button" value="接口管理" />
			</li>
			<li>
				<input type="button" value="${message("admin.setting.other")}" />
			</li>
            <li>
                <input type="button" value="门店体验" />
            </li>
            <li>
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="qrEcodeimageUploadPath" class="text" value="${setting.qrEcodeimageUploadPath}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="barCodeimageUploadPath" class="text" value="${setting.barCodeimageUploadPath}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="moneyRechargeGodMoney" class="text" value="${setting.moneyRechargeGodMoney}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="godMoneyRechargeMoney" class="text" value="${setting.godMoneyRechargeMoney}" maxlength="200" />
				</td>
			</tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="text" name="godMoneyExchangePoint" class="text" value="${setting.godMoneyExchangePoint}" maxlength="200" />
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <p>
                        原因一：<input type="text" name="packetRefuseSeasonOne" class="text" value="${setting.packetRefuseSeasonOne}" maxlength="200" />
                    </p>
                    <p>
                        原因二：<input type="text" name="packetRefuseSeasonTwo" class="text" value="${setting.packetRefuseSeasonTwo}" maxlength="200" />
                    </p>
                    <p>
                        原因三：<input type="text" name="packetRefuseSeasonThree" class="text" value="${setting.packetRefuseSeasonThree}" maxlength="200" />
                    </p>
                    <p>
                        原因四：<input type="text" name="packetRefuseSeasonFour" class="text" value="${setting.packetRefuseSeasonFour}" maxlength="200" />
                    </p>
                </td>
            </tr>
		...
		<table class="input tabContent">
            <tr>
                <th>
                    <span class="requiredField">*</span>首页商品图片:
                </th>
                <td>
                    <p>
                    默认图片:
                    <input type="text" name="coolGoodsDefaultImg" class="text" value="${setting.coolGoodsDefaultImg}" />
                    </p>
                    <p>
                    默认文字:
                    <input type="text" name="coolGoodsDefaultName" class="text" value="${setting.coolGoodsDefaultName}" />
                    </p>
                </td>
            </tr>
		...
		<table class="input tabContent">
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>项目部署路径:
                </th>
                <td>
                    <input type="text" name="projectPath" class="text" value="${setting.projectPath}" maxlength="200" />
                </td>
            </tr>
		...
		<table class="input tabContent">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="kuaidi" class="text" value="${setting.kuaidi}" maxlength="200" />
                </td>
            </tr>
            <tr>
                <th>
                ${message("Setting.smsHost")}:
                </th>
                <td>
                    <input type="text" id="smsHost" name="smsHost" class="text" value="${setting.smsHost}" maxlength="200" />
                </td>
            </tr>
            <tr>
                <th>
                ${message("Setting.smsPort")}:
                </th>
                <td>
                    <input type="text" id="smsPort" name="smsPort" class="text" value="${setting.smsPort}" maxlength="200" />
                </td>
            </tr>
            <tr style="display: none;">
                <th>
                ${message("Setting.statusCode")}:
                </th>
                <td>
                    <input type="text" id="statusCode" name="statusCode" class="text" value="${setting.statusCode}" maxlength="200" />
                </td>
            </tr>
			<tr>
				<th>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="smsApplication" class="text" value="${setting.smsApplication}" maxlength="200" />
                </td>
            </tr>
			<tr>
				<th>
            ...
            <tr>
                <th>
                    <span class="requiredField">*</span>是否启用短信:
                </th>
                <td>
                    <input type="checkbox" id="smsIsEnable" name="smsIsEnable" value="true"[#if setting.smsIsEnable] checked="checked"[/#if] />
                    <input type="hidden" name="_smsIsEnable" value="false" />
                </td>
            </tr>
            <tr>
                <th>
                    <span class="requiredField">*</span>是否启用邮件:
                </th>
                <td>
                    <input type="checkbox" id="mailIsEnable" name="mailIsEnable" value="true"[#if setting.mailIsEnable] checked="checked"[/#if] />
                    <input type="hidden" name="_mailIsEnable" value="false" />
                </td>
            </tr>
            <tr style="display: none;">
                <th>
                ...
                <td>
                    <input type="text" id="locale" name="locale" class="text" value="${setting.locale}" maxlength="200" />
                </td>
            </tr>
			<tr class="hidden">
				<th>
        ...
        <table class="input tabContent">
            <tr>
                <td>
                    <textarea id="lineExperience" name="lineExperience" class="editor"
                              style="width: 100%;">${setting.lineExperience}</textarea>
                </td>
            </tr>
        </table>
        ...
        <table class="input tabContent">
            <tr>
                <td>
                    <textarea id="footerAbout" name="footerAbout" class="editor"
                              style="width: 100%;">${setting.footerAbout}</textarea>
                </td>
            </tr>
        </table>
        ...
        <table class="input tabContent">
            <tr>
                <td>
                    <textarea id="footerContact" name="footerContact" class="editor"
                              style="width: 100%;">${setting.footerContact}</textarea>
                </td>
            </tr>
        </table>
        ...
        <table class="input tabContent">
            <tr>
                <td>
                    <textarea id="footerLawInfo" name="footerLawInfo" class="editor"
                              style="width: 100%;">${setting.footerLawInfo}</textarea>
                </td>
            </tr>
        </table>
