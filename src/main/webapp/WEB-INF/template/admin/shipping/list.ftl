	...
	<form id="listForm" action="list.jhtml" method="get">
		<div class="bar">
			<div class="buttonGroup">
                [@shiro.hasPermission name="admin:shipping-edit"]
		...
		<table id="listTable" class="list">
			<tr>
                ...
                [@shiro.hasPermission name = "admin:shipping-print"]
                    <th>
                    ...
                    [@shiro.hasPermission name = "admin:shipping-print"]
                        <td>
                            <select name="print">
                                ...
                                <option value="../print/order.jhtml?id=${shipping.order.id}">${message("admin.order.orderPrint")}</option>
                                <option value="../print/product.jhtml?id=${shipping.order.id}">${message("admin.order.productPrint")}</option>
                                <option value="../print/shipping.jhtml?id=${shipping.id}">${message("admin.order.shippingPrint")}</option>
                                [#if shipping.order.isDelivery]
                                    <option value="../print/delivery.jhtml?orderId=${shipping.order.id}">${message("admin.order.deliveryPrint")}</option>
                                [/#if]
                            </select>
                        </td>
                    [/@shiro.hasPermission]
