...
(function($) {
	...
	$.fn.extend({
		...
		uploader: function(options) {
			var settings = {
				url: prefix+'/admin/file/upload.jhtml',
				fileType: "image",
				fileName: "file",
				data: {},
				maxSize: 10,
		...
		editor: function(options) {
			window.UEDITOR_CONFIG = {
				UEDITOR_HOME_URL: prefix+'/resources/admin/ueditor/',
				serverUrl: prefix+'/admin/file/upload.jhtml',
