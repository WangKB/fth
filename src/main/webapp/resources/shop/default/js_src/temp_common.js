...
$().ready(function() {
	...
	$(document).ajaxComplete(function(event, request, settings) {
		...
		if (tokenStatus == "accessDenied") {
			...
			if (url.indexOf(prefix+"/register/") == 0 || url.indexOf(prefix+"/login/") == 0 || url.indexOf(prefix+"/cart/") == 0 || url.indexOf(prefix+"/order/") == 0) {
				showHeaderCartQuantity();
			}
		}
	});
